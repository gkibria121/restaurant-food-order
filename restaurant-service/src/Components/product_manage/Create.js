...
axios.get(url + '/sanctum/csrf-cookie').then((rsp) => {
  ...
  .catch((error)=>
  {
    ...
    console.log(imageError,priceError,nameError,descError)
...
<div className="w-full">
  <form onSubmit= {(e)=>{submit(e)}} className="bg-white shadow-md rounded px-8 pt-6 pb-8 mb-4" action="http://127.0.0.1:8000/item">
    <div className="mb-4">
      ...
      <input value={name}  onChange={(e)=>{setName(e.target.value)}} name="name" className="shadow appearance-none border rounded w-full py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:shadow-outline" id="username" type="text" placeholder="Enter Product Name" />
    ...
    <div className="mb-6">
      ...
      <input value={price}  onChange={(e)=>{setPrice(e.target.value)}} name="price" className="shadow appearance-none border rounded w-full py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:shadow-outline" id="username" type="text" placeholder="Enter Product Price" />
    ...
    <div className="mb-6">
        ...
        <input value={desc}  onChange={(e)=>{setDesc(e.target.value)}}  name="desc" className="shadow appearance-none border rounded w-full py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:shadow-outline placeholder:mt-0" id="username" type="text" placeholder="Enter Product Description" />
 ...
 <input type="hidden" id="category" name="category_id" value={Selects} />
  <select id="categoryOptions" className="mx-2" onChange={(e)=>{setSelects(e.target.value)}}>
